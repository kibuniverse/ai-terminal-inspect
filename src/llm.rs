...
const LLM_URL: &str = "https://api.minimaxi.com/v1/text/chatcompletion_v2";
const API_KEY: &str = "sk-api-E-O5nVQLTDGBBWvi_D9uCUQMwZyIZwlGSoJUp0AauTcqBuxWjo_sBG0PpcWw6j-VIouzj_lGh5wU59NYAQZREXTgbmRnjwI5N9hIL1xtLqQCN1cNpnwVpoA";
...
pub async fn call_llm(input: &str) -> Result<String, String> {
